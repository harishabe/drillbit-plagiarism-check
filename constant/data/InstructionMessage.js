export const INSTRUCTIONS_STEPS = {
    ...
    'STUDENT': {
        'STEP_1': 'student page - Enroll students in a class by clicking the "+Students" icon, add single students or multiple students using a template, and then create assignments under the "Assignment" tab',
    },
    'STUDENT_SUBMISSION': {
