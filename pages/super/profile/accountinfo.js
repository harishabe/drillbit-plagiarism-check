...
const AccountInfo = ({
    ...
    useEffect(() => {
        let row = [
            ...
            createData('Institution Name', '--'),
            createData('Admin Username', '--'),
            createData('Account ID', '--'),
            createData('Date Of Activation', '--'),
            createData('Instructor Account', '--'),
            createData('Student Account', '--'),
            createData('Number Of Documents', '--'),
            createData('Max. document length(pages)', '--'),
            createData('Date of Expiry', '--'),
            createData('Grammar checks', '--'),
            createData('Product Name', '--'),
            createData('Time Zone', '--'),
        ];
        setRows([...row]);
    }, [accountInfo]);
