    ...
    const handleAction = (e, icon, rowData) => {
        if (icon === 'edit') {
            ...
            router.push({
                ...
                query: {
                    name: rowData.assignment_name?.props?.title, folderId: rowData.ass_id, grammar: grammarSubscription?.toUpperCase() === 'YES' ? rowData.grammar : grammarSubscription, translation: translation?.toUpperCase()
                }
            });
        }
    };
