...
const MyFoldersForms = ({
    ...
    useEffect(() => {
        if (editData !== undefined) {
            ...
            setExcludeRefBib(editData?.ex_references?.toUpperCase());
            setExcludeQuote(editData?.ex_quotes?.toUpperCase());
            setExcludeSmallSource(editData?.small_sources?.toUpperCase());
            setGrammarCheck(editData?.grammar?.toUpperCase());
            setExcludePhrases(editData?.ex_phrases?.toUpperCase());
