    ...
    const componentList = [
        ...
        <GDriveFileUpload
            ...
            routerObj={ {
                ...
                query: { name: router.query.name, folderId: router.query.folderId, grammar: router.query.grammar, translation: router.query.translation }
            } }
        />,
        <ZipFileUpload
            key={ 2 }
            ...
            routerObj={ { pathname: '/pro/user/folderSubmission', query: { name: router.query.name, folderId: router.query.folderId, grammar: router.query.grammar, translation: router.query.translation } } }
        />,
        <UploadFiles
            key={ 3 }
            choseFileTitle='Browse your file here'
