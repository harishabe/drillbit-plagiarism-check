...
const BrightSpaceForm = ({
    ...
    const onSubmit = (data) => {
        if (editOperation) {
            ...
            ChangeConfig(BASE_URL_PRO + END_POINTS_PRO.ADMIN_BRIGHTSPACE_INTEGRATION, detailedData);
        } else {
            let detailedData = {
                ...data, 'method': data.method?.name
            };
            LmsIntegration(BASE_URL_PRO + END_POINTS_PRO.ADMIN_BRIGHTSPACE_INTEGRATION, detailedData);
        }
    };
...
export default connect(mapStateToProps, mapDispatchToProps)(BrightSpaceForm);