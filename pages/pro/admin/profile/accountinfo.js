    ...
    useEffect(() => {
        if (role === Role.proAdmin) {
            let row = [
                ...
                createData("Total Documents Submitted", accountInfo?.oneDocumentLength ? accountInfo?.oneDocumentLength : '-'),
                createData("Files Saved to Repository", accountInfo?.expiryDate ? accountInfo?.expiryDate : '-'),
