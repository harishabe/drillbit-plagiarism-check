...
const ChangePassword = ({ ProfileChangePassword, isLoading }) => {
  ...
  const onSubmit = (data) => {
    ...
    ProfileChangePassword(
      data,
      BASE_URL_PRO + END_POINTS_PRO.PROFILE_CHANGE_PASSWORD
    );
  };
...
const mapDispatchToProps = (dispatch) => {
  return {
    ProfileChangePassword: (requestPayload, apiUrl) =>
      dispatch(ProfileChangePassword(requestPayload, apiUrl)),
  };
};
