...
const Announcements = () => {
  ...
  return (
    <React.Fragment>
      ...
      {cardViewsData.map((cardView, index) => (
        <>
          <CardView height={cardHeights[index]}>
            <Grid container spacing={2}>
              ...
              <Grid item md={2} >
                <Title title={cardView.title} className={classes.title}/>
                <div className={classes.time}>{` ${cardView.timestamp}`}</div>
                {/* <SubTitle2 title={` ${cardView.timestamp}`} /> */}
                </Grid>
                ...
                <SubTitle2
                  title={
                    showMoreIndex === index
                      ? cardView.content
                      : limitContent(cardView.content, 110)
                  }
                />
              </Grid>
