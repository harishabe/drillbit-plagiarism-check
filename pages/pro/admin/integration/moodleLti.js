...
const MoodleLTI = ({
    ...
    useEffect(() => {
        GetIntegrationDetailData(BASE_URL_PRO + END_POINTS_PRO.ADMIN_MOODLE_LTI_INTEGRATION);
    }, []);
...
export default connect(mapStateToProps, mapDispatchToProps)(MoodleLTI);