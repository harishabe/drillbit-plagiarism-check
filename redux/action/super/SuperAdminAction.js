 ...
 */
export const EditAccount = (url, getUrl, data) => {
  return {
    type: types.FETCH_SUPER_ADMIN_EDIT_ACCOUNT_START,
    url: url,
    getUrl: getUrl,
    query: data,
  };
...
export const DeleteAccount = (licenseId, role) => {
  return {
    type: types.FETCH_SUPER_ADMIN_DELETE_ACCOUNT_START,
    licenseId: licenseId,
    role: role,
  };
};
...
export const SuperCreateStudent = (url, data) => {
  return {
    type: types.FETCH_SUPER_ADMIN_EXT_CREATE_STUDENT_START,
    url: url,
    query: data,
  };
};
...
export const SuperEditStudent = (url, data) => {
  return {
    type: types.FETCH_SUPER_ADMIN_EXT_EDIT_STUDENT_START,
    url: url,
    query: data,
  };
};
...
export const GlobalSearch = (url) => {
  return {
    type: types.FETCH_SUPER_ADMIN_GLOBAL_SEARCH_START,
    url: url,
  };
};
...
export const MakeHimAdmin = (url, paginationPayload) => {
  return {
    type: types.FETCH_SUPER_ADMIN_MAKE_HIM_ADMIN_START,
    url: url,
    paginationPayload: paginationPayload,
  };
};
...
export const ResendCredentials = (role, data) => {
  return {
    type: types.FETCH_SUPER_ADMIN_RESEND_CREDENTIALS_START,
    role: role,
    data: data,
  };
};
