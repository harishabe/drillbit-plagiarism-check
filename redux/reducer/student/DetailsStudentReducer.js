...
const DetailsStudentReducer = (state = {}, action) => {
    switch (action.type) {
        ...
        case types.FETCH_STUDENTS_DOWNLOAD_ORIGINAL_FILE_START:
            return {
                ...state,
                isLoadingDownloadFile: true,
            };
        case types.FETCH_STUDENTS_DOWNLOAD_ORIGINAL_FILE_SUCCESS:
            return {
                ...state,
                isLoadingDownloadFile: false,
                downloadFileData: action.payload,
            };
        case types.FETCH_STUDENTS_DOWNLOAD_ORIGINAL_FILE_FAIL:
            return {
                ...state,
                isLoadingDownloadFile: false,
