...
const IntegrationInstructionWhiteIcon = (props) => {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="#fff" xmlns="http://www.w3.org/2000/svg" style={{ marginLeft: '-4px', marginRight: '-4px' }} {...props}>
<g clipPath="url(#clip0_6_16054)">
<path d="M11 14.17L8.83 12L11 9.82997L9.59 8.40997L6 12L9.59 15.59L11 14.17Z" fill="#fff"/>
<path d="M14.41 15.59L18 12L14.41 8.40997L13 9.82997L15.17 12L13 14.17L14.41 15.59Z" fill="#fff"/>
...
export default IntegrationInstructionWhiteIcon